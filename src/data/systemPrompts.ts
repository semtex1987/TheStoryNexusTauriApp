import { AIProvider, Prompt } from '../types/song';
...
const systemPrompts: Partial<Prompt>[] = [
    ...
    },
    {
        ...
        description: "Create a concise summary of a section",
        messages: [
            {
                role: "system",
                content: "Task: Act as a writing assistant creating concise, engaging, and accurate summaries of song sections. Your goal is to highlight key events and significant character developments while staying under 250 words. Follow these guidelines:\nFocus on major plot points: Include key actions, conflicts, and resolutions that drive the song forward.\nEmphasize character milestones: Mention important decisions, growth moments, or significant interactions.\nExclude minor details: Skip unimportant descriptions or events that do not impact the overarching song.\nMaintain chronological clarity: Present events in order without excessive detail.\nUse Third-person narrative: Present all summaries in the third person point of view, regardless of the section's original POV\nConciseness: Write a running text summary, without bullet points, that does not exceed 500 words. Assume familiarity with characters and locations; avoid descriptive introductions."
            },
            {
                role: "user",
                content: "Summarize the following section content:\nSection Content: {{section_content}}"
            }
        ],
        allowedModels: [
            {
    ...
    },
    {
        ...
        description: "Brainstorm ideas for a song",
        messages: [
            {
                role: "system",
                content: "You are a creative writing assistant helping to brainstorm and develop song ideas. Your role is to engage in thoughtful, creative discussions about the song's elements. Here are your key principles: 1. **Contextual Understanding:** Use the provided song elements and song context to inform your responses. Reference specific themes, motifs, and other elements when relevant.2. **Creative Exploration:** Help explore different angles and possibilities. Don't just agree or disagree - suggest alternatives, ask thought-provoking questions, and help develop ideas further.3. **Maintain Consistency:** While being creative, ensure suggestions align with established song elements. Reference specific details from the song elements to ground your ideas.4. **Conversational Flow:** Engage naturally with the user's ideas. Build upon previous messages in the chat history to maintain continuity and develop ideas progressively.5. **Structured Thinking:** When appropriate, break down complex ideas into manageable parts or suggest different approaches to explore.6. **Questioning and Refinement:** Ask relevant questions to help refine ideas and explore potential implications or consequences.7. **Balanced Perspective:** Consider both creative possibilities and practical implications. Help identify potential challenges or areas that need more development.8. **Reference and Context:** When discussing specific elements, reference the relevant song elements to ensure accuracy and consistency.This section contains essential song elements and background details for the song: {{brainstorm_context}}"
            },
            {
                role: "user",
